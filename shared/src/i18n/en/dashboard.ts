...
const dashboard: TranslationStrings = {
  ...
  'dashboard.currentLocation': 'Start Location',
  'dashboard.currentLocationPlaceholder': 'e.g. Current Location / City',
  'dashboard.useCurrentLocation': 'Use current location',
  'dashboard.selectLocation': 'Destination Location',
  'dashboard.selectLocationPlaceholder': 'e.g. Tokyo, Paris, Surat...',
  'dashboard.tripRoute': 'Trip Route & Locations',
  'dashboard.detectingLocation': 'Detecting...',
  'dashboard.locationDetected': 'Current location detected!',
  'dashboard.locationDenied': 'Unable to access your device location',
